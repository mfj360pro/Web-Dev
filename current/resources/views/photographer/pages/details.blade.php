                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="{{json_decode($upload['value'])[0]}}" id="link" type="text" class="form-control form-control-alternative">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea id="iframe" rows="6" type="text" class="form-control form-control-alternative">{{json_decode($upload['value'])[1]}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                            ...
                                            @else
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="form-control-label">Link</label>
                                                            <input value="" id="link" type="text" class="form-control form-control-alternative">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="form-control-label">iFrame (embed link)</label>
                                                            <textarea id="iframe" rows="6" type="text" class="form-control form-control-alternative"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
