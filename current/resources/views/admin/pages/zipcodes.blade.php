        ...
        <div class="modal-dialog">
            <div class="modal-content card bg-secondary shadow">
                <div class="modal-header card-header bg-white border-0">
                    <h4 class="card-title">Zipcode Information</h4>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Zipcode ID</label>
...
@section('content')
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
        <div class="container-fluid">
            <p class="text-white display-2">Zipcodes</p>
        </div>
    </div>
            ...
            $(grid_table).jsGrid({
                ...
                controller: {
                    ...
                    insertItem: function(item) {
                        Controller.Create('/WebService/UpsertZipcode', item).done(function(data) {
                            
                        });
                    },
                    updateItem: function(item) {
                        Controller.Update('/WebService/UpsertZipcode', item).done(function(data) {
                            
                        });
                    },
                    deleteItem: function(item) {
                        Controller.Delete('/WebService/DeleteZipcode', item).done(function(data) {
                ...
                fields: 
                    [
                        ...
                        {   name: "zipcode",    type: "text",       width: 100, title: "Zipcode"                    },
